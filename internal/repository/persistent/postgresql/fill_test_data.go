...
func (p *PostgreSQL) FillTestData() error {
	...
	INSERT INTO instances (instance_id, name, service_fk)
	VALUES (1, 'Магазин в Донецке', 1),
		   (2, 'Магазин в Луганске', 1),
		   (3, 'Магазин в Ростове', 1),
		   (4, 'Магазин в Макеевке', 1),
		   (5, 'Магазин в Матвеев-Кургане', 1),
		   (6, 'Склад в Донецке', 2),
		   (7, 'Склад в Ростове', 2),
		   (8, 'Сервис выдачи прав', 3),
		   (9, 'Сервис поиска оптимальных маршрутов доставки', 5),
		   (10, 'Планировщик закупок', 6);

/*
Package joint.
Пакет для работы с объединенным хранилищем, служащим в качестве единой точки обращения к in memory и постоянному
хранилищу. Для создания структуры Repository, с методами для работы объединенного хранилища, используется функция
MustCreate. Эта же функция в фоне проводит кеширование части данных из постоянного хранилища в оперативную память.
*/
package joint
